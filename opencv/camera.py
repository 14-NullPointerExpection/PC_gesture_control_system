...
import cv2
from cv2 import dnn, COLOR_BGR2YCrCb
import numpy as np
...
def opencamera(model_path):
    ...
    while True:
        ...
        src_image = frame
        cv2.rectangle(src_image, (100, 100), (400, 400), (0, 255, 0), 1, 4)#画出一个矩形框
        ...
        src_image = cv2.putText(src_image, str(class_name[classId]), (300, 100), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 0, 255), 2, 4)
